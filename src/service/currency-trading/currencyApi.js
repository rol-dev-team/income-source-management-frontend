...
// export const getCurrencyPostingsPaginated = async (
//   page = 1, 
//   limit = 10, 
//   status = "", 
//   showDeleted = false
// ) => {
//   const response = await apiClient.get(`/currency-trading/currency-posting`, {
//     params: { 
//       page, 
//       limit, 
//       status,
...
// export const deleteCurrencyPosting = async (id) => {
//   const response = await apiClient.delete(`/currency-trading/currency-posting${id}`);
//   return response.data;
// };
...
export const deleteCurrencyPosting = async (id) => {
  const response = await apiClient.post(`/currency-trading/currency-posting/${id}/soft-delete`);
  return response.data;
};

export const restoreCurrencyPosting = async (id) => {
  const response = await apiClient.put(`/currency-trading/currency-posting/${id}/restore`);
  return response.data;
};
...
// export const getCurrencyPostingsPaginated = (currentPage, pageSize, status) => {
//   return apiClient.get("/currency-trading/currency-posting", {
//     params: { 
//       page: currentPage, 
//       pageSize: pageSize,
//       status: status
