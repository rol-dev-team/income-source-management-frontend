...
export const deleteBankDepositPostingSoftDelete = async (id) => {
  const response = await apiClient.post(`/bank-deposit/posting/${id}/soft-delete`);
  return response.data;
};

export const restoreBankDepositPosting = async (id) => {
  const response = await apiClient.put(`/bank-deposit/posting/${id}/restore`);
  return response.data;
};
