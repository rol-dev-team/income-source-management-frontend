...
export const deleteLoanPostingSoftDelete = async (id) => {
  const response = await apiClient.post(`/loan/posting/${id}/soft-delete`);
  return response.data;
};

export const restoreLoanPosting = async (id) => {
  const response = await apiClient.put(`/loan/posting/${id}/restore`);
  return response.data;
};
