...
import { getCurrencyPartiesPaginated } from "../../service/currency-trading/currencyApi";
...
const PartyPage = () => {
      ...
      useEffect(() => {
        const loadData = async () => {
          setLoading(true);
          try {
            const res = await getCurrencyPartiesPaginated(currentPage, pageSize);
            setData(res.data);
    ...
    const columns = [
        ...
        { header: "Mobile", accessor: "mobile", sortable: true },
      ...
      navigate(`/currency-trading/create-party`, { state: { currency } });
    };
  ...
  return (
    <div>
      ...
      <DataTable
            ...
            title="Currency Parties"
            link="/currency-trading/create-party"
          />
    </div>
  )
}
