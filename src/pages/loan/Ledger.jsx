...
const Ledger = () => {
    ...
    const handleSummaryTransactionChange = (selectedOption) => {
        ...
        // Auto-apply filter for summary transaction type
        setFilters(prev => ({
            ...prev,
            summary_transaction_type: newValue,
            transaction_type: newValue === "all" ? "all" : newValue,
    ...
    const handleViewTypeChange = (selectedOption) => {
        ...
        if (newViewType === "summary") {
            updatedFilters.view_type = newViewType;
            updatedFilters.summary_transaction_type = "all";
                            ...
                            <>
                                <SelectField
                                    ...
                                    onChange={(selectedOption) => {
                                        ...
                                        // Auto-apply filter for transaction type
                                        setFilters(prev => ({
                                            ...prev,
                                ...
                                <div className="relative">
                                    <DatePickerInput
                                        ...
                                        onDateChange={(date) => {
                                            ...
                                            // Auto-apply filter for start date
                                            setFilters(prev => ({
                                                ...prev,
                                ...
                                <div className="relative">
                                    <DatePickerInput
                                        ...
                                        onDateChange={(date) => {
                                            ...
                                            // Auto-apply filter for end date
                                            setFilters(prev => ({
                                                ...prev,
                        ...
                        {formik.values.view_type === "summary" && (
                            <SelectField
                                ...
                                value={summaryTransactionOptions.find(
                                    (opt) =>
                                        opt.value ===
                                        (formik.values.summary_transaction_type || "all")
                                )}
                                onChange={handleSummaryTransactionChange}
                            />
                        )}
                    ...
                    {/* <div className="flex gap-2 mt-2 md:mt-0">
                        ...
                        {formik.values.view_type === "details" && (
                            <CSVLink
                                ...
                                headers={csvHeaders}
                                filename={"ledger-data.csv"}
                                className="btn border-0 bg-green-700 hover:bg-green-600 text-white font-bold rounded transition-colors duration-200"
                            >
                                Export CSV
                            </CSVLink>
                        )}
