...
// import {
//   getIncomeExpensePostingsPaginated,
//   updateIncomeExpensePostingStatus,
...
//       setLoading(true);
//       try {
//         const res = await getIncomeExpensePostingsPaginated(
//           currentPage,
//           pageSize,
//           filterStatus
//         );
...
//       try {
//         const response = await updateIncomeExpensePostingStatus(
//           selectedPosting.id,
//           values
//         );
//         showToast.success(
...
//       sortable: true,
//     },
//     { header: "Income / Expense Head", accessor: "head_name", sortable: true },
...
//     navigate(`/income-expense/postings-create`, { state: { currency } });
//   };
...
//         link='/income-expense/postings-create'
//       />
...
import {
  getIncomeExpensePostingsPaginated,
  updateIncomeExpensePostingStatus,
  deleteIncomeExpensePostingSoftDelete,
  restoreIncomeExpensePosting,
} from "../../service/income-expense/incomeExpenseApi";
...
const PostingPage = ({ isDeleteRestoreMode = false, defaultFilterStatus = "" }) => {
  ...
  const handleDelete = async (postingId) => {
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        setLoading(true);
        const response = await deleteIncomeExpensePostingSoftDelete(postingId);
  ...
  const handleRestore = async (postingId) => {
    if (window.confirm("Are you sure you want to restore this record?")) {
      try {
        setLoading(true);
        const response = await restoreIncomeExpensePosting(postingId);
  ...
  return (
    <div>
      <DataTable
        ...
        handleFilterChangeStatus={handleFilterChangeStatus}
        title='Income & Expense Postings'
        link={isDeleteRestoreMode ? null : '/income-expense/postings-create'}
