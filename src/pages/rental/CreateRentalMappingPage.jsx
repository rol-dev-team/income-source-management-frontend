...
const WALLET_PAYMENT_CHANNEL_ID = 15;
const WALLET_ACCOUNT_ID = 9;
...
const CreateRentalMappingPage = () => {
  ...
  const handlePaymentChannelSelectChange = (option) => {
    ...
    }else if (String(selectedId) === String(WALLET_PAYMENT_CHANNEL_ID)) {
      formik.setFieldValue("account_id", WALLET_ACCOUNT_ID);
    }  else {
              ...
              <SelectField
                ...
                isDisabled={
                  String(formik.values.payment_channel_id) ===
                    String(CASH_PAYMENT_CHANNEL_ID) || String(formik.values.payment_channel_id) ===
                    String(WALLET_PAYMENT_CHANNEL_ID)
                }
                isLoading={
