...
// const CreateHousePartyMappingPage = () => {
...
//         const partyResMapped = (partyRes.data || []).map((p) => ({
//           value: p.id,
//           label: p.party_name,
//         }));
//         setPartyOptions(partyResMapped);
...
//       try {
//         // if (partyToEdit) {
//         //   await updateHousePartyMapping(partyToEdit?.id, payload);
//         //   showToast.success("Posting updated successfully!");
//         // } else {
//         //   await createHousePartyMapping(payload);
//         //   showToast.success("Posting created successfully!");
//         // }
//         // resetForm();
//         // navigate("/rental/house-party-mapping");
//       } catch (error) {
...
//   //     const houseIds = partyToEdit.house_id ? [partyToEdit.house_id] : [];
//   //     formik.setFieldValue("house", findOptions(houseOptions, houseIds || []));
...
//   //     formik.setFieldValue("account_id", partyToEdit.account_id || "");

//   //     formik.setFieldValue("monthly_rent", partyToEdit.monthly_rent || "");
//   //     formik.setFieldValue(
//   //       "auto_adjustment",
//   //       partyToEdit.auto_adjustment || ""
//   //     );
//   //     formik.setFieldValue(
//   //       "rent_start_date",
//   //       partyToEdit.rent_start_date || ""
//   //     );
//   //   }
//   // }, [partyToEdit, paymentChannelOptions, houseOptions]);

//   useEffect(() => {
//     if (partyToEdit && houseOptions.length && paymentChannelOptions.length) {
//       // Party Name
//       formik.setFieldValue(
//         "party_name",
//         findOption(partyOptions, partyToEdit.party_name || partyToEdit.id)
//       );

//       // House
//       formik.setFieldValue(
//         "house",
//         findOption(houseOptions, partyToEdit.house_id)
//       );
...
//       formik.setFieldValue(
//         "payment_channel_id",
//         findOption(paymentChannelOptions, partyToEdit.payment_channel_id)
//       );

//       // Account ID
//       formik.setFieldValue(
//         "account_id",
//         findOption(accountOptions, partyToEdit.account_id)
//       );
...
//   };
//   console.log("posting... ", partyToEdit);
...
//             {partyToEdit
//               ? "Update House Party Mapping "
//               : "Create House Party Mapping"}
//           </h4>
...
//                 onChange={(option) =>
//                   formik.setFieldValue("party_name", option)
//                 }
...
//                 // }
//                 options={houseOptions}
//                 value={formik.values.house} // now it's {value,label} or null
//                 onChange={(option) => formik.setFieldValue("house", option)}
...
//                 onChange={(val) => {
//                   if (formik.values.rent_start_date !== val) {
//                     formik.setFieldValue("rent_start_date", val);
//                   }
//                 }}
//               />
...
// export default CreateHousePartyMappingPage;
...
const CreateHousePartyMappingPage = () => {
  ...
  console.log("edit data : ", partyToEdit);
  ...
  }, [partyToEdit, houseOptions, partyOptions, paymentChannelOptions]);
