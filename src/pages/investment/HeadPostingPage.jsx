...
import { getInvestmentPartyPaginated } from "../../service/investmentApi";
...
const HeadPostingPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      try {
        const res = await getInvestmentPartyPaginated(currentPage, pageSize);
        setData(res.data);
  ...
  const handleEdit = (currency) => {
    navigate(`/investment/head-create`, { state: { currency } });
  };
